#############################################################################
# Makefile for building: QtDemo.app/Contents/MacOS/QtDemo
# Generated by qmake (3.1) (Qt 6.7.3)
# Project:  QtDemo.pro
# Template: app
# Command: /usr/local/bin/qmake -o Makefile QtDemo.pro
#############################################################################
...
CFLAGS        = -pipe -O2 $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX15.0.sdk -mmacosx-version-min=14.0 -Wall -Wextra -fPIC $(DEFINES)
CXXFLAGS      = -pipe -stdlib=libc++ -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX15.0.sdk -mmacosx-version-min=14.0 -Wall -Wextra -fPIC $(DEFINES)
INCPATH       = -I. -I/usr/local/lib/QtWidgets.framework/Headers -I/usr/local/lib/QtGui.framework/Headers -I/usr/local/lib/QtCore.framework/Headers -I. -I/Library/Developer/CommandLineTools/SDKs/MacOSX15.0.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX15.0.sdk/System/Library/Frameworks/AGL.framework/Headers -I. -I/Library/Developer/CommandLineTools/SDKs/MacOSX15.0.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX15.0.sdk/System/Library/Frameworks/AGL.framework/Headers -I/usr/local/share/qt/mkspecs/macx-clang -F/usr/local/lib
...
DISTDIR = /Users/sunjinlei/Projects/Qt-Project/.tmp/QtDemo1.0.0
LINK          = /Library/Developer/CommandLineTools/usr/bin/clang++
LFLAGS        = -stdlib=libc++ -headerpad_max_install_names $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX15.0.sdk -mmacosx-version-min=14.0 -Wl,-rpath,@executable_path/../Frameworks -Wl,-rpath,/usr/local/lib
...
DIST          = /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		...
		/usr/local/Cellar/qt/6.7.3/share/qt/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/6.7.3/share/qt/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/6.7.3/share/qt/mkspecs/common/macx.conf \
		/usr/local/Cellar/qt/6.7.3/share/qt/mkspecs/common/sanitize.conf \
		/usr/local/Cellar/qt/6.7.3/share/qt/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/6.7.3/share/qt/mkspecs/common/gcc-base-mac.conf \
		/usr/local/Cellar/qt/6.7.3/share/qt/mkspecs/common/clang.conf \
		/usr/local/Cellar/qt/6.7.3/share/qt/mkspecs/common/clang-mac.conf \
		...
		QtDemo.pro mainwindow.h main.cpp \
		mainwindow.cpp
QMAKE_TARGET  = QtDemo
DESTDIR       = 
TARGET        = QtDemo.app/Contents/MacOS/QtDemo
...
EXPORT__PRO_FILE_ = /Users/sunjinlei/Projects/Qt-Project/QtDemo.pro


include /usr/local/Cellar/qt/6.7.3/share/qt/mkspecs/features/mac/sdk.mk
first: all
####### Build rules

QtDemo.app/Contents/MacOS/QtDemo: ui_mainwindow.h $(OBJECTS)  
	@test -d QtDemo.app/Contents/MacOS/ || mkdir -p QtDemo.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: QtDemo.pro /usr/local/share/qt/mkspecs/macx-clang/qmake.conf /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		/usr/local/share/qt/mkspecs/features/device_config.prf \
		/usr/local/Cellar/qt/6.7.3/share/qt/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/6.7.3/share/qt/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/6.7.3/share/qt/mkspecs/common/macx.conf \
...
QtDemo.app/Contents/PkgInfo: 
	@test -d QtDemo.app/Contents || mkdir -p QtDemo.app/Contents
	@$(DEL_FILE) QtDemo.app/Contents/PkgInfo
	@echo "APPL????" > QtDemo.app/Contents/PkgInfo
QtDemo.app/Contents/Info.plist: 
	@test -d QtDemo.app/Contents || mkdir -p QtDemo.app/Contents
	@$(DEL_FILE) QtDemo.app/Contents/Info.plist
	@plutil -convert xml1 -o - /usr/local/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.QtDemo,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.QtDemo,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,QtDemo,g" -e "s,@LIBRARY@,QtDemo,g" -e "s,\$${EXECUTABLE_NAME},QtDemo,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >QtDemo.app/Contents/Info.plist

all: Makefile \
		QtDemo.app/Contents/PkgInfo \
		QtDemo.app/Contents/Info.plist QtDemo.app/Contents/MacOS/QtDemo
...
moc_predefs.h: /usr/local/share/qt/mkspecs/features/data/dummy.cpp
	/Library/Developer/CommandLineTools/usr/bin/clang++ -pipe -stdlib=libc++ -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX15.0.sdk -mmacosx-version-min=14.0 -Wall -Wextra -fPIC -dM -E -o moc_predefs.h /usr/local/share/qt/mkspecs/features/data/dummy.cpp
...
moc_mainwindow.cpp: mainwindow.h \
	...
	/usr/local/share/qt/libexec/moc $(DEFINES) --include /Users/sunjinlei/Projects/Qt-Project/moc_predefs.h -I/usr/local/share/qt/mkspecs/macx-clang -I/Users/sunjinlei/Projects/Qt-Project -I/usr/local/lib/QtWidgets.framework/Headers -I/usr/local/lib/QtGui.framework/Headers -I/usr/local/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX15.0.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/15.0.0/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX15.0.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/usr/local/lib mainwindow.h -o moc_mainwindow.cpp
